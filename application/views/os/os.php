...
<script>
    function redirectToUrl(idOs) {
        // Construa a URL com base na base_url() e idOs
        var url = "<?php echo base_url('index.php/os/visualizar/'); ?>" + idOs;
