        ...
        <div class="widget-box">
            <div class="widget-title" style="margin: -20px 0 0">
                ...
                <div class="buttons">
                    ...
                    <a title="Visualizar OS" class="button btn btn-primary" href="<?php echo site_url() ?>/ordem/visualizar??=<?php echo $result->tokenOs; ?>">
                ...
                ?>
<script>
function enviarWhats(zapnumber, texto_de_notificacao) {
    // Realize uma chamada AJAX para o seu controller
    $.ajax({
        type: 'POST',
        url: '<?php echo site_url("os/enviarWhats"); ?>',
        data: {
            number: zapnumber,
