...
<head>
    ...
    <style>
        ...
        #floating-button {
            ...
            color: #fff;
            padding: 20px; /* Ajusta o tamanho do botão */
            border: none;
            border-radius: 50%; /* Torna o botão redondo */
            cursor: pointer;
            font-size: 20px;
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
            z-index: 1001; /* Atribua um valor maior ao z-index */
        }
        ...
        #qrModal {
            ...
            box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);
            z-index: 1000;
            border-radius: 10px; /* Adiciona bordas arredondadas ao modal */
        }

        /* Estilize o botão de fechar do modal */
        .close {
            position: absolute;
            top: 10px;
            right: 10px;
...
<div id="qrModal">
    ...
    <label for="cameraDropdown">Escolha a câmera:</label>
...
<script>
    ...
    // Function to populate the camera dropdown with available cameras
   function populateCameraDropdown(cameras, indicePadrao) {
    ...
    // Define a opção padrão selecionada
    dropdown.selectedIndex = indicePadrao;
}
            ...
            navigator.mediaDevices.getUserMedia({ video: true }).then(function (stream) {
                ...
                Instascan.Camera.getCameras().then(function (cameras) {
                    if (cameras.length > 0) {
                        ...
                        // Start scanning when the selected camera changes
                        document.getElementById('cameraDropdown').addEventListener('change', function () {
                            const selectedCameraIndex = parseInt(this.value, 10);
